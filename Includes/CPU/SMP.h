...
#ifndef THEOS_ENABLE_SCHED_TESTS
#define THEOS_ENABLE_SCHED_TESTS      1
#endif
...
#else
#define SMP_SCHED_STRESS_ENABLE       0
#define SMP_SCHED_BALANCE_TEST_ENABLE 0
#define SMP_SCHED_PATHO_TEST_ENABLE   0
#endif
